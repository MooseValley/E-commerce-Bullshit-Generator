...
public class EcommerceBullshitGenerator
{
   public static final String[] ADVERBS_ARRAY =
      {
         ...
         "energistically", "enthusiastically", "globally", "holistically", "interactively", "intrinsically", "monotonectally",
   ...
   public static final String[] VERBS_ARRAY =
      {
   ...
   public static final String[] ADJECTIVES_ARRAY =
      {
   ...
   public static final String[] NOUNS_ARRAY =
      {
   ...
   public static String generateBuzzwordStatement ()
   {
      String buzzwordsStr = ADVERBS_ARRAY    [generator.nextInt(ADVERBS_ARRAY.length)]    + " " +
                            VERBS_ARRAY      [generator.nextInt(VERBS_ARRAY.length)]      + " " +
                            ADJECTIVES_ARRAY [generator.nextInt(ADJECTIVES_ARRAY.length)] + " " +
                            NOUNS_ARRAY      [generator.nextInt(NOUNS_ARRAY.length)];
      return buzzwordsStr;
   }
   ...
   public static void main (String[] args)
   {
      ...
      for (int k = 0; k < 10; k++)
      {
         System.out.println (generateBuzzwordStatement () );
      }
   }
}